...
const FAQS = [
  {
    q: "什么是画引？",
    a: "画引是一个专注于 AI 图像生成的高质量提示词库。我们收录经过测试验证的提示词，覆盖人像、风景、科幻、赛博朋克、奇幻、城市、自然、动物、建筑、静物、美食、时尚、角色、抽象、电商视觉、视频提示词等主题，帮助创作者快速找到灵感，一键复制即可使用。"
  },
  {
    q: "提示词是如何被验证的？",
  ...
  {
    q: "可以自由使用这些提示词吗？",
    a: "是的，画引上的公开提示词均可免费浏览和复制。你可以将它们用于个人创作、商业项目或学习参考；具体生成结果和外部素材仍需自行核对来源授权、模型条款和商业使用范围。"
  },
  {
    q: "如何按需筛选提示词？",
